<!-- Thanks for the PR! Keep it focused; squash-merge collapses the branch to one commit. -->
...
<!-- Notable implementation details, trade-offs, or alternatives considered. -->

## Testing

<!-- How did you verify this? `make check` output, manual steps, screenshots for UI changes. -->
