...
- **"Update available (v0.7.0 → v0.8.0)".** Appears only when a newer version exists. Click **Update** to see what's new and update in place; see [Updating](02-install.md#updating).
