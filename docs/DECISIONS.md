...
- **Verification:** mutation-tested per claim, with the coverage boundary stated rather than implied.
  ...
  - Full suite: 766 server + 272 dashboard; 785 server with `AUTONOMOS_INTEGRATION=1`.
