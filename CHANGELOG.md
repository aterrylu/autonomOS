...
- [#361](https://github.com/aterrylu/autonomOS/pull/361) `cdfec15` — feat(dashboard): right-click Rename agent — restart-under-new-name (ADR-096)
...
- [#377](https://github.com/aterrylu/autonomOS/pull/377) `f827dd4` — fix(mcp): bundle channel-server deps inline — MCP bridge self-contained on bundle installs (#376)
- [#378](https://github.com/aterrylu/autonomOS/pull/378) `35d952d` — fix(runtime): Codex crash-net retains the resumable thread (ADR-100)
- [#379](https://github.com/aterrylu/autonomOS/pull/379) `22f4f32` — fix(codex): read the current rollout reply shape for the unread badge
